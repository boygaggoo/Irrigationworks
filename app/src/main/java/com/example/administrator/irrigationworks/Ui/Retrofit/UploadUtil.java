...
public class UploadUtil {
    ...
    private BuildingCheckItemActivity contexts;
    ...
    public String toArcUploadFile(BuildingCheckItemActivity context, File file, String fileKey, String RequestURL, Map<String, String> param) {
        String result = null;
        contexts=context;
        requestTime= 0;
...
//                  dos.flush();
            ...
            //    builder.setProcessMax3((int)file.length());
            ...
            while ((len = is.read(bytes)) != -1) {
                ...
                //       builder.setProcessValue3(curLen);
                //       builder.setFilesizes(Math.round(curLen/1024)+"kb/"+Math.round(file.length()/1024)+"kb");
                //       builder.update();
            }
            is.close();
...
//          dos.write(tempOutputStream.toByteArray());
            ...
            if (res == 200) {
                ...
                while((x=reader.readLine())!=null) {
                    if(x!=null)
                        result=x.toString();
                    result = new String(result.getBytes(), "utf-8"); // 设置编码方式
                }
                Log.e(TAG, result);
                return result;
            } else {
...
//          dos.write(tempOutputStream.toByteArray());
            ...
            if (res == 200) {
                ...
                result = new String(sb1.toString().getBytes("utf-8"), "utf-8");
                */
