...
public class BuildatlasListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BuildatlasListAdapter(Context mContext) {
        this.mContext = mContext;
    }

    public BuildatlasListAdapter(Context mContext, List<TaskDbbean> mAskList, AMap aMap, Circle circle) {
        this.mContext = mContext;
