...
import com.example.administrator.irrigationworks.Ui.adapter.BuildatlasListAdapter;
 ...
 */
public class BuildatlasActivity extends BaseAppCompatActivity implements
    ...
    private BuildatlasListAdapter findasklistadapter;
    //临时设置限时操作
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try{
            Boolean net = NetUtil.checkNetWork(BuildatlasActivity.this);
            if (net) {
//            initRefresh();
...
//            adapterInit();
                ...
                UtilsTool.showShortToast(BuildatlasActivity.this, "没有网络");
            }
        }catch (Exception e){
...
//                }
    ...
    private void showAdapter(final List<TaskDbbean> rolebeans) {
        if (rolebeans != null) {
            findasklistadapter = new BuildatlasListAdapter(this, rolebeans,aMap,circle);
            ...
            if (loginOnSuccssBean.getCode().equals(Enumerate.LOGINSUCESS)) {
                if(loginOnSuccssBean.getResult().equals("[]")){
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            UtilsTool.showShortToast(BuildatlasActivity.this, "没有工地信息");
                        }
                    });
...
//            //获取对象
                ...
                if (rolebeans == null || rolebeans.size() == 0) {
                    UtilsTool.showShortToast(BuildatlasActivity.this, "没有任务");
                    return;
                }
