...
public class HidSaveItemListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public HidSaveItemListAdapter(Context mContext) {
        this.mContext = mContext;
    }

    public HidSaveItemListAdapter(Context mContext, List<TaskChechItembean> historBeans) {
        this.mContext = mContext;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof ItemViewHolder) {
            ...
            if(moreItem.getObjs().equals("不通过")){
                ...
                itemViewHoleder.tv_resutl.setTextColor(Color.RED);//系统自带的颜色类
                Drawable drawable=mContext.getResources().getDrawable(R.mipmap.nopass);
                drawable.setBounds(0,0,40,30);
                itemViewHoleder.tv_resutl.setCompoundDrawables(null,null,drawable,null);
            }else if(moreItem.getObjs().equals("通过")){
                itemViewHoleder.tv_resutl.setText(moreItem.getObjs());
                itemViewHoleder.tv_resutl.setTextColor(Color.BLUE);//系统自带的颜色类
                Drawable drawable=mContext.getResources().getDrawable(R.mipmap.pass);
                drawable.setBounds(0,0,40,30);
                itemViewHoleder.tv_resutl.setCompoundDrawables(null,null,drawable,null);
            }
