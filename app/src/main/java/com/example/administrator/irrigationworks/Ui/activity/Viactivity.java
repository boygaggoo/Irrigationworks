...
import com.example.administrator.irrigationworks.UtilsTozals.FaceRect;
import com.example.administrator.irrigationworks.UtilsTozals.FaceUtil;
import com.example.administrator.irrigationworks.UtilsTozals.ParseResult;
...
public class Viactivity extends Activity {
    private final static String TAG = Viactivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAcc = new Accelerometer(Viactivity.this);
        mFaceDetector = FaceDetector.createDetector(Viactivity.this, null);
    }
    ...
    private void initUI() {
        ...
        setSurfaceSize();
        mToast = Toast.makeText(Viactivity.this, "", Toast.LENGTH_SHORT);
    }
