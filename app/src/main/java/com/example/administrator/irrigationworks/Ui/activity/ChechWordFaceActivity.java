 ...
 */
public class ChechWordFaceActivity extends BaseAppCompatActivity implements OnClickListener {
...
//                    int second = calendar.get(Calendar.SECOND);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        onlinePick.setOnClickListener(ChechWordFaceActivity.this);
        onlineReg.setOnClickListener(ChechWordFaceActivity.this);
        onlineCamera.setOnClickListener(ChechWordFaceActivity.this);
        onlineDetect.setOnClickListener(ChechWordFaceActivity.this);
        onlineAlign.setOnClickListener(ChechWordFaceActivity.this);
        onlineVerify.setOnClickListener(ChechWordFaceActivity.this);
        rlAttendance.setOnClickListener(ChechWordFaceActivity.this);
    ...
    protected int getLayoutId() {
        return R.layout.activity_check_on_word;
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_PICTURE_CHOOSE) {
            ...
            if (null != bmp) {
                FaceUtil.saveBitmapToFile(ChechWordFaceActivity.this, bmp);
            }
            // 获取图片保存路径
            fileSrc = FaceUtil.getImagePath(ChechWordFaceActivity.this);
            // 获取图片的宽和高
