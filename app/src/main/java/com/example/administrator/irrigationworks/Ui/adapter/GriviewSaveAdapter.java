...
public class GriviewSaveAdapter extends BaseAdapter {
    private ArrayList<String> mDatas;
    private Context mcontext;

    public GriviewSaveAdapter(ArrayList<String> mDatas) {
        this.mDatas = mDatas;
    }

    public void setDatas(Context context, ArrayList<String> beans) {
 ...
 */
        ...
        vlp.getmImageLoader().get(FinalTozal.host+mDatas.get(position), vlp.getOne_listener());
