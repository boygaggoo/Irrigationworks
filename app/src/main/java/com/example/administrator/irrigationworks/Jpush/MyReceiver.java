...
//		Intent is = new Intent(context, LoginActivity.class);
//		//i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//		is.putExtra(Constants.danger, Constants.dangerWarn);
...
//				processCustomMessage(context, bundle);
				...
				//打开自定义的Activity
				Intent i = new Intent(context, TeanActivity.class);
				i.putExtras(bundle);
				//i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
				i.putExtra(Constants.danger, Constants.dangerWarn);
